...
Both achieve ~97.5% accuracy on the test set (97.54% backprop, ~97.3% EGGROLL). With the optimized implementation, EGGROLL uses almost the same memory (~433MB vs ~391MB) and is ~6x slower (~27s vs ~4.5s).
